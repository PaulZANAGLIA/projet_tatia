...
print('PETITE SELECTION HETEROGENE')
...
df.drop(df.index[sumf + int(sumf*2):], inplace=True)
...
print(contentSDG)
fichier = open("Classification_report_PH_SDG.txt", "a")
...
print(contentMulti)
fichier = open("Classification_report_PH_MultinomialNB.txt", "a")
...
skplt.metrics.plot_confusion_matrix(train.target, pred_train_lrsgd,
                                    normalize=True,
                                    title="Petit heterogene MultinomialNB",
                                    cmap="Purples",
                                    ax=ax
                                    )
plt.show()
...
print(contentMPL)
fichier = open("Classification_report_PH_MPL.txt", "a")
...
skplt.metrics.plot_confusion_matrix(train.target, pred_train_lrsgd,
                                    normalize=True,
                                    title="Petit heterogene MPL 5 it",
                                    cmap="Purples",
                                    ax=ax
                                    )
plt.show()
...
print(contentSVC)
fichier = open("Classification_report_PH_SVC.txt", "a")
