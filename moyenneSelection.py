...
print('MOYENNE SELECTION HOMOGENE')
...
#Les deux lignes ci dessous : Taille echantillon : 100
df.drop(df.index[50:sumf], inplace=True)
...
print(contentSDG)
fichier = open("Classification_report_moyenne_SDG.txt", "a")
...
print(contentMulti)
fichier = open("Classification_report_moyenne_MultinomialNB.txt", "a")
...
skplt.metrics.plot_confusion_matrix(train.target, pred_train_lrsgd,
                                    normalize=True,
                                    title="Moyenne selection MultinomialNB",
                                    cmap="Purples",
                                    ax=ax
                                    )
plt.show()
...
print(contentMPL)
fichier = open("Classification_report_moyenne_MPL.txt", "a")
...
skplt.metrics.plot_confusion_matrix(train.target, pred_train_lrsgd,
                                    normalize=True,
                                    title="Moyenne selection MPL 5 iterations",
                                    cmap="Purples",
                                    ax=ax
                                    )
plt.show()
...
print(contentSVC)
fichier = open("Classification_report_moyenne_SVC.txt", "a")
