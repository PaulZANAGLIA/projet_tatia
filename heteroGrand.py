...
df.drop(df.index[sumf + int(sumf*8):], inplace=True)
...
print(contentSDG)
fichier = open("Classification_report_GH_SDG.txt", "a")
...
print(contentMulti)
fichier = open("Classification_report_GH_MultinomialNB.txt", "a")
...
skplt.metrics.plot_confusion_matrix(train.target, pred_train_lrsgd,
                                    normalize=True,
                                    title="Grand heterogene MultinomialNB",
                                    cmap="Purples",
                                    ax=ax
                                    )
plt.show()
...
print(contentMPL)
fichier = open("Classification_report_GH_MPL.txt", "a")
...
skplt.metrics.plot_confusion_matrix(train.target, pred_train_lrsgd,
                                    normalize=True,
                                    title="Grand heterogene MPL 5 it",
                                    cmap="Purples",
                                    ax=ax
                                    )
plt.show()
...
print(contentSVC)
fichier = open("Classification_report_GH_SVC.txt", "a")
