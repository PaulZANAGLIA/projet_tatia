...
print('SELECTION MAXIMALE HOMOGENE')
...
#Les deux lignes ci dessous : Taille echantillon : 2 * nombre cas frauduleux
df.drop(df.index[2*sumf:], inplace=True)
...
print(contentSDG)
fichier = open("Classification_report_maximale_SDG.txt", "a")
...
print(contentMulti)
fichier = open("Classification_report_maximale_MultinomialNB.txt", "a")
...
print(contentMPL)
fichier = open("Classification_report_maximale_MPL.txt", "a")
...
skplt.metrics.plot_confusion_matrix(train.target, pred_train_lrsgd,
                                    normalize=True,
                                    title="Selection maximale MPL 5 iterations",
                                    cmap="Purples",
                                    ax=ax
                                    )
plt.show()
...
print(contentSVC)
fichier = open("Classification_report_maximale_SVC.txt", "a")
