...
#while (plus < 20): # A servi pour obtenir des tailles diverses jusqu'a la quasi totalite de la base de donnees
while (plus <=8):
    ...
    lrsgd = SGDClassifier(loss='hinge', penalty='l2',alpha=1e-3, random_state=42,max_iter=5, tol=None)
    ...
    tabAccurancySDG.append(metrics.accuracy_score(train.target, pred_train_lrsgd))
    ...
    predicted = clf.predict(X_new_tfidf)
    pred_train_lrsgd = clf.predict(X_train_tfidf)
    tabAccurancyMultinomialNB.append(metrics.accuracy_score(train.target, pred_train_lrsgd))
...
#    tabAccurancyMLP.append(metrics.accuracy_score(train.target, pred_train_lrsgd))
    ...
    predicted = clf.predict(X_new_tfidf)
    pred_train_lrsgd = clf.predict(X_train_tfidf)
    tabAccurancySVC.append(metrics.accuracy_score(train.target, pred_train_lrsgd))
...
print('tabAccurancyMLP   ', tabAccurancyMLP)
print('tabAccurancyMultinomialNB   ', tabAccurancyMultinomialNB)
print('tabAccurancySVC   ', tabAccurancySVC)
print('tabAccurancySDG    ', tabAccurancySDG)

plt.plot(tabSize, tabAccurancySDG)
...
plt.plot(tabSize, tabAccurancyMultinomialNB)
plt.xlabel('Taille echantillon')
plt.ylabel('Accuracy_score')
plt.title('MultinomialNB')
plt.show()

plt.plot(tabSize, tabAccurancySVC)
plt.xlabel('Taille echantillon')
plt.ylabel('Accuracy_score')
plt.title('SVC')
plt.show()