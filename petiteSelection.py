...
print(contentSDG)
fichier = open("Classification_report_petite_SDG.txt", "a")
...
print(contentMulti)
fichier = open("Classification_report_petite_MultinomialNB.txt", "a")
...
print(contentMPL)
fichier = open("Classification_report_petite_MPL.txt", "a")
...
print(contentSVC)
fichier = open("Classification_report_petite_SVC.txt", "a")
